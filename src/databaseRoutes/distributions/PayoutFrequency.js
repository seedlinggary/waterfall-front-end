      ...
      <Form.Select aria-label="Default select example"   onChange={(e) => handlePayoutChange(e.target.value,'payout_type')} >
        ...
        <Form.Group as={Col} controlId="formGridEmail">
          ...
          <Form.Group as={Col} controlId="formGridEmail">
            ...
            <Form.Control  value={payoutFrequency.startingAmount} onChange={(e) => handlePayoutChange(e.target.value, 'startingAmount')} />
          </Form.Group>
           
          <Form.Group as={Col} controlId="formGridEmail">
            <Form.Label>Amount percentage increase per {payoutFrequency.payout_frequency } for savings.</Form.Label>
            <Form.Control  value={payoutFrequency.mulitplicationAmount} onChange={(e) => handlePayoutChange(e.target.value, 'mulitplicationAmount')} />
          </Form.Group> 
