...
return (
<>
  <td key={i}>{(mortgage_info.mbill.principal_paid + mortgage_info.mbill.remaining_balance).toLocaleString()}</td>
...
return (
<>
  <td key={i}>{mortgage_info.amount}</td>
...
return (
<>
  <td key={i}>{mortgage_info.mbill.rate}</td>
...
return (
<>
  <td key={i}>{mortgage_info.mbill.interest_paid}</td>
...
return (
<>
  <td key={i}>{mortgage_info.mbill.principal_paid}</td>
...
return (
<>
  <td key={i}>{mortgage_info.mbill.remaining_balance}</td>
...
return (
<>
  <td key={i}>{mortgage_info.mbill.total_principal_payment}</td>
...
return (
<>
  <td key={i}>{mortgage_info.mbill.total_interest_payment}</td>
