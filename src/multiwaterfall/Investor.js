...
const Investor = ({investor, setInvestor,personId, payoutFrequency}) => {
    ...
    function handleInvestorChange(e, mortgageInfoType) {
        ...
        <div key={personId}> 
          ...
          {payoutFrequency.transactions && payoutFrequency.transactions.map((transaction, i) => {
            ...
            <DatePicker selected={changeDate(investor[personId].date_funds_recieved)}  onChange={(e) => handleInvestorChange(e,'date_funds_recieved')}  />
